...
<body>
  <div class="container">
    <div class="nav">
        ...
        <span class="version">V3 SINGLE-MOTOR v3.3.5 (Interrupt Fix)</span>
    </div>
    ...
    <div id="log">Bereit. v3.3.5: ISR active.</div>
  </div>
...
void TaskCore1(void * pvParameters) {
    for(;;) {
        ...
        if (sys.pendingTest != -1) { int m = sys.pendingTest; sys.pendingTest = -1; runSpeedTest(m); }
        updateMotors();
        vTaskDelay(1);
    }
}
