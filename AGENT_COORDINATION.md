...
- **Stand:** 2026-05-05
- **Branch:** `v4-modular`
- **Firmware:** **v4.1.7** auf `perlin-v4.intern.gaengeviertel.de` (192.168.193.22) — Phase 8 läuft (v4.1.7: EdgeC + Wave-Accel aktiv). [Bug-Log](v4/docs/project_perlin_bugs.md)
