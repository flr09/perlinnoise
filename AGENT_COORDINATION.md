...
- **Stand:** 2026-05-05
- **Branch:** `v4-modular`
- **Firmware:** **v4.1.9** auf `perlin-v4.intern.gaengeviertel.de` (192.168.193.22) — Phase 8 läuft als 7-Tag-Plan v4.1.7 → v4.2.2 (siehe `v4/README.md`). v4.1.9 = Persistence Config mit 5 s Debounce gegen NVS-Wear-Out (Bug-ID 23a). [Bug-Log](v4/docs/project_perlin_bugs.md)
