...
- **Stand:** 2026-05-05
- **Branch:** `v4-modular`
- **Firmware:** **v4.1.6** auf `perlin-v4.intern.gaengeviertel.de` (192.168.193.22) — Phase 8 läuft als Aufteilung in 5 Tags (v4.1.6–v4.2.0). v4.1.6 = Hardware Fan/Lamp HAL aktiv. [Bug-Log](v4/docs/project_perlin_bugs.md)
