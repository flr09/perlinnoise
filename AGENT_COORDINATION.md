...
- **Stand:** 2026-05-05
- **Branch:** `v4-modular`
- **Firmware:** **v4.1.5** auf `perlin-v4.intern.gaengeviertel.de` (192.168.193.22) — Phase 7 abgeschlossen, Calib-Skip aktiv (Calib-Zeit ~15 s → ~5 s), Bauhaus-Refactor (NoiseEngine konsolidiert, Hal_Tacho-Toter-Code raus). [Bug-Log](v4/docs/project_perlin_bugs.md)
