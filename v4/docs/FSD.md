...
**Stand:** 2026-05-05 — Firmware **v4.1.10** auf Hardware. Phase 8 läuft als 7-Tag-Plan v4.1.7 → v4.2.2. v4.1.10 = Preset-Slots in NVS (8×, Bug-ID 23b). Persistence-Strang (Config + Presets) damit komplett.
**Branch:** `v4-modular`
