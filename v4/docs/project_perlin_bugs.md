...
| 54 | 2026-05-15 | 🔴 | Speed-Slider Range / Engine-Cap / Contrast-Altlast | ✅ v4.4.30 (Passiver Limiter + Cap Sync) |
...
| 68 | 2026-05-16 | 🔵 | **v_peak-Formel-Diagnose & Range-Konvention.** | ✅ v4.4.32 (Engine auf pp-Konvention umgestellt, synchron mit UI) |
...
| 81 | 2026-05-17 | 🔴 | **UI Memory Leak (Log-Flood):** /status lieferte 6KB redundante Logs pro 100ms. | ✅ v4.4.29 (drainBuffer() implemented) |
| 82 | 2026-05-17 | 🟡 | **Saw-Welle zu "weich":** Potenzkurve verhinderte abrupten Retract. | ✅ v4.4.30 (Lineare Rampe + Symmetrie-Steuerung) |
| 83 | 2026-05-17 | 🟡 | **Slider "Pulling":** Slider zogen sich gegenseitig aktiv mit. | ✅ v4.4.31 (Passiver Limiter: nur .max Update) |
| 84 | 2026-05-17 | 🟣 | **Multi-Tier Dynamics:** Wunsch nach leise/langsam vs. rasant/kraftvoll. | ✅ v4.4.31 (Slow/Normal/Rasant Profile) |
| 87 | 2026-05-17 | 🔴 | **Range Factor-2 Mismatch:** Engine rechnet peak, UI zeigt pp → 2x Over-Travel. | ✅ v4.4.32 (pp-Konvention in Engine \& Caps vereinheitlicht) |
| 88 | 2026-05-17 | 🟡 | **Saw Sharpness:** Retract nicht aggressiv genug. | ✅ v4.4.32 (accCap 500k + Dynamics Scaling) |
| 89 | 2026-05-17 | 🟡 | **Slider Out-of-Sync:** Engine-Caps wurden in der UI nicht angezeigt. | ✅ v4.4.32 (applyConfig in pollStatus + DRAG-Guard) |
| 90 | 2026-05-17 | 🔵 | **Stability Monitoring:** Fehlende Heap-Einsicht bei Abstürzen. | ✅ v4.4.32 (heap-Info in /status integriert) |
