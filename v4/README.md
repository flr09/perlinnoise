...
**Stand:** 2026-05-09 — Firmware **v4.3.5** auf `perlin-v4.intern.gaengeviertel.de` (192.168.193.22). Phasen 1–9 ✅ abgeschlossen.
**Branch:** `v4-modular`
...
- **Phase 9** Dynamics under the hood — TMC-Tuning, 256 µSteps, SG4 (5-Tag-Plan, läuft):
  ...
  - **v4.3.5** ✅ Player-Watchdog v1 (Bug 41). `Synthesis::tickWatchdog` 3-s-Fenster, ratio < 0.5 → Synth-Stop + Log. Aktiv im Wave-Mode mit Halb-Amp > 250 Steps und 0.3 Hz < f < tachoCutoffHz. v1 ohne Auto-Recovery (User reagiert manuell). Smoke-Test 27 s ohne false-positive.
