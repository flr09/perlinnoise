...
- **Phase 9** Dynamics under the hood — TMC-Tuning, 256 µSteps, SG4 (5-Tag-Plan, läuft):
  ...
  - **v4.3.2** ⚪ FreqSweep v3 (High-Freq 500 Hz & SG4 Fusion). [Spezifikation](docs/spec_freqsweep_v3.md). API in L3 + TCOOLTHRS sicher konfiguriert (SGTHRS=0, kein DIAG-Trigger).
